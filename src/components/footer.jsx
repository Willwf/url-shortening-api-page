export function Footer() {
  return (
    <footer
      className="sans bg-very-dark-violet flex flex-col justify-between items-center gap-8
                lg:flex-row lg:py-[8vh] lg:justify-evenly lg:items-start"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="mt-14 mb-4 w-32 h-8
                  lg:m-0"
      >
        <path
          fill="#fff"
      ...
      <div
        className="flex flex-col justify-between items-center
                  lg:items-start"
      >
        <p className="text-white mb-4">Features</p>
        <a className="text-light-gray hover:text-cyan text-sm mb-3" href="#">
          Link Shortening
        </a>
        <a className="text-light-gray hover:text-cyan text-sm mb-3" href="#">
          Branded Links
        </a>
        <a className="text-light-gray hover:text-cyan text-sm" href="#">
          Analytics
        </a>
      </div>
      ...
      <div
        className="flex flex-col justify-between items-center
                  lg:items-start"
      >
        <p className="text-white mb-4">Resources</p>
        <a className="text-light-gray hover:text-cyan text-sm mb-3" href="#">
          Blog
        </a>
        <a className="text-light-gray hover:text-cyan text-sm mb-3" href="#">
      ...
      <div className="flex justify-between items-center gap-6 mb-14">
        <a href="#">
          <svg
            ...
            width="24"
            height="24"
            className="fill-white hover:fill-blue-500"
          >
