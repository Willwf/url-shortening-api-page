export function Footer() {
  return (
    <footer className="sans bg-very-dark-violet flex flex-col justify-between items-center gap-8">
      <svg xmlns="http://www.w3.org/2000/svg" className="mt-14 mb-4 w-32 h-8">
        <path
          fill="#fff"
